...
func start_fancy_idle_3d() -> void:
	...
	scale_tween.tween_property(scale_anchor, "scale:y", start_scale_y * (1.0 + scale_factor), scale_speed)
	scale_tween.chain().tween_property(scale_anchor, "scale:y", start_scale_y * (1.0 - scale_factor), scale_speed)
	scale_tween.chain().tween_property(scale_anchor, "scale:y", start_scale_y * (1.0 + scale_factor), scale_speed)
	scale_tween.chain().tween_property(scale_anchor, "scale:y", start_scale_y * (1.0 - scale_factor), scale_speed)
