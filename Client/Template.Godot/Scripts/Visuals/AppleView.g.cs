...
public partial class AppleView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<AppleViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<GrassComponent, DTransform2D, AppleViewModel>(
            ctx => new AppleViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(AppleViewModel vm)
    {
    ...
    private void OnRemoved(AppleViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<AppleViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
