...
public partial class LandView : Node3D
{
    ...
    private readonly Dictionary<LandViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<LandComponent, DTransform2D, LandViewModel>(
    ...
    private void OnAdded(LandViewModel vm)
    {
    ...
    private void OnRemoved(LandViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<LandViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
