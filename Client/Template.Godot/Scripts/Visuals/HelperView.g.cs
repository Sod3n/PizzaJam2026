...
public partial class HelperView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<HelperViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<HelperComponent, DTransform2D, HelperViewModel>(
            ctx => new HelperViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(HelperViewModel vm)
    {
    ...
    private void OnRemoved(HelperViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<HelperViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
