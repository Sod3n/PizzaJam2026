...
public partial class MushroomCaveView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<MushroomCaveViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var query = client.Reactive.ObservableCollection<MushroomCaveComponent, DTransform2D>();
    ...
    private void OnAdded(MushroomCaveViewModel vm)
    {
    ...
    private void OnRemoved(MushroomCaveViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<MushroomCaveViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
    ...
    partial void OnSpawned(MushroomCaveViewModel vm, Node3D visualNode);
    ...
    partial void OnDespawned(MushroomCaveViewModel vm, Node3D visualNode);
