...
public partial class HelperPlayerViewModel : EntityViewModel
{
    public HelperPlayerDefinitionModel HelperPlayer { get; }
    public SkinComponentModel Skin { get; }
    public ReactiveProperty<bool> IsHidden { get; } = new();

    public HelperPlayerViewModel(Context context) : base(context)
    {
        HelperPlayer = new HelperPlayerDefinitionModel(ReactiveSystem.Instance, context);
        Disposables.Add(HelperPlayer);
