...
public partial class HelperPlayerView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<HelperPlayerViewModel, Node3D> _spawnedEntities = new();
    ...
    private void OnAdded(HelperPlayerViewModel vm)
    {
    ...
    private void OnRemoved(HelperPlayerViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<HelperPlayerViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
