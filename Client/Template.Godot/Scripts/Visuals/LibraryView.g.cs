...
public partial class LibraryView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<LibraryViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<LibraryComponent, DTransform2D, LibraryViewModel>(
            ctx => new LibraryViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(LibraryViewModel vm)
    {
    ...
    private void OnRemoved(LibraryViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<LibraryViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
