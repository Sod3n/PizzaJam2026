...
public partial class FoodSignView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<FoodSignViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<FoodSignComponent, DTransform2D, FoodSignViewModel>(
            ctx => new FoodSignViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(FoodSignViewModel vm)
    {
    ...
    private void OnRemoved(FoodSignViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<FoodSignViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
