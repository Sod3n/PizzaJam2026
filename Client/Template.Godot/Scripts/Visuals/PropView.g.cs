...
public partial class PropView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<PropViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<PropComponent, DTransform2D, PropViewModel>(
            ctx => new PropViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(PropViewModel vm)
    {
    ...
    private void OnRemoved(PropViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<PropViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
