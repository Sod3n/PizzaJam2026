...
public partial class CarrotView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<CarrotViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<GrassComponent, DTransform2D, CarrotViewModel>(
            ctx => new CarrotViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(CarrotViewModel vm)
    {
    ...
    private void OnRemoved(CarrotViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<CarrotViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
