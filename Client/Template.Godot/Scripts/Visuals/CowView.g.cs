...
public partial class CowView : Node3D
{
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<CowComponent, DTransform2D, CowViewModel>(
    ...
    private void OnAdded(CowViewModel vm)
    {
    ...
    private void OnRemoved(CowViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<CowViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
