...
public partial class HelperPetView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<HelperPetViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<HelperPetComponent, DTransform2D, HelperPetViewModel>(
            ctx => new HelperPetViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(HelperPetViewModel vm)
    {
    ...
    private void OnRemoved(HelperPetViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<HelperPetViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
