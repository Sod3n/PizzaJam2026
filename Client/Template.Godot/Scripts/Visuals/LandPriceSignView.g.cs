...
public partial class LandPriceSignView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<LandPriceSignViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<LandPriceSignComponent, DTransform2D, LandPriceSignViewModel>(
            ctx => new LandPriceSignViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(LandPriceSignViewModel vm)
    {
    ...
    private void OnRemoved(LandPriceSignViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<LandPriceSignViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
