...
public partial class GrassView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<GrassViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<GrassComponent, DTransform2D, GrassViewModel>(
    ...
    private void OnAdded(GrassViewModel vm)
    {
    ...
    private void OnRemoved(GrassViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<GrassViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
