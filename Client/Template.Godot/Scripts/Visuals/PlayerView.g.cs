...
public partial class PlayerView : Node3D
{
    ...
    private readonly Dictionary<PlayerViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<PlayerEntity, DTransform2D, PlayerViewModel>(
    ...
    private void OnAdded(PlayerViewModel vm)
    {
    ...
    private void OnRemoved(PlayerViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<PlayerViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
    ...
    partial void OnDespawned(PlayerViewModel vm, Node3D visualNode);
