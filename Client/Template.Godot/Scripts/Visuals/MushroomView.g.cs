...
public partial class MushroomView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<MushroomViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<GrassComponent, DTransform2D, MushroomViewModel>(
            ctx => new MushroomViewModel(ctx),
            _disposables
        );
    ...
    private void OnAdded(MushroomViewModel vm)
    {
    ...
    private void OnRemoved(MushroomViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<MushroomViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
