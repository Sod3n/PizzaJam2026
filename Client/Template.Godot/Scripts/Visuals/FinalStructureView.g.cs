...
public partial class FinalStructureView : Node3D
{
    [Export] public PackedScene Prefab;

    private readonly CompositeDisposable _disposables = new();
    private readonly Dictionary<FinalStructureViewModel, Node3D> _spawnedEntities = new();
    ...
    private void Register()
    {
        ...
        var list = client.Reactive.ObservableList<FinalStructureComponent, DTransform2D, FinalStructureViewModel>(
    ...
    private void OnAdded(FinalStructureViewModel vm)
    {
    ...
    private void OnRemoved(FinalStructureViewModel vm)
    {
    ...
    {
        foreach (var vm in new List<FinalStructureViewModel>(_spawnedEntities.Keys))
            OnRemoved(vm);
    }
