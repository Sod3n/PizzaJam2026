...
public static partial class LandPriceSignDefinition
{
    ...
    {
        var entity = ctx.CreateEntity<LandPriceSignComponent>();

        ref var component = ref ctx.GetComponent<LandPriceSignComponent>(entity);
        ...
        component = ref ctx.GetComponent<LandPriceSignComponent>(entity);
    ...
    static partial void OnEntityCreated(Context ctx, Entity entity, ref LandPriceSignComponent component, Dictionary<string, Entity> childEntities);
}
