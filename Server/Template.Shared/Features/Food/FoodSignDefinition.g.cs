...
public static partial class FoodSignDefinition
{
    ...
    {
        var entity = ctx.CreateEntity<FoodSignComponent>();

        ref var component = ref ctx.GetComponent<FoodSignComponent>(entity);
        ...
        component = ref ctx.GetComponent<FoodSignComponent>(entity);
    ...
    static partial void OnEntityCreated(Context ctx, Entity entity, ref FoodSignComponent component, Dictionary<string, Entity> childEntities);
}
