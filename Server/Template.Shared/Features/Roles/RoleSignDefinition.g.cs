...
public static partial class RoleSignDefinition
{
    ...
    {
        var entity = ctx.CreateEntity<RoleSignComponent>();

        ref var component = ref ctx.GetComponent<RoleSignComponent>(entity);
        ...
        component = ref ctx.GetComponent<RoleSignComponent>(entity);
    ...
    static partial void OnEntityCreated(Context ctx, Entity entity, ref RoleSignComponent component, Dictionary<string, Entity> childEntities);
}
