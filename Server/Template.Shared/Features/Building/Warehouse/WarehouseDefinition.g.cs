...
public static partial class WarehouseDefinition
{
    ...
    {
        var entity = ctx.CreateEntity<WarehouseComponent>();

        ref var component = ref ctx.GetComponent<WarehouseComponent>(entity);
        component.Enabled = 0;
        ...
        ctx.AddComponent(entity, CollisionShape2D.CreateRectangle(new Vector2(2.991519f, 2f)));

        var childEntities = new Dictionary<string, Entity>
        {
        };
        component = ref ctx.GetComponent<WarehouseComponent>(entity);
