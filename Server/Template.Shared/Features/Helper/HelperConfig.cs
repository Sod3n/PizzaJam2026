...
public static class HelperConfig
{
    ...
    public static readonly HelperInfo Gatherer = new("gatherer", "Lefantis", 75, 150, 2f, 4f);
    public static readonly HelperInfo Seller = new("seller", "Mochi", 500, 1000, 2f, 4f);
    public static readonly HelperInfo Builder = new("builder", "Brix", 500, 1000, 2f, 4f);
    public static readonly HelperInfo Milker = new("milker", "Daisy", 125, 250, 2f, 4f);
