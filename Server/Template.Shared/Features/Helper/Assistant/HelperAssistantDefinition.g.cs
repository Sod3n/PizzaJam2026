...
[EntityDefinition(
    typeof(Transform2D),
    typeof(HelperAssistantComponent),
    typeof(StaticBody2D),
...
public static partial class HelperAssistantDefinition
{
    ...
    {
        var entity = ctx.CreateEntity<HelperAssistantComponent>();

        ref var component = ref ctx.GetComponent<HelperAssistantComponent>(entity);
        ...
        component = ref ctx.GetComponent<HelperAssistantComponent>(entity);
