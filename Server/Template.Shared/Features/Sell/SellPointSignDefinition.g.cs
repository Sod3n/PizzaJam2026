...
public static partial class SellPointSignDefinition
{
    ...
    {
        var entity = ctx.CreateEntity<SellPointSignComponent>();

        ref var component = ref ctx.GetComponent<SellPointSignComponent>(entity);
        component.SellPointId = Entity.Null;
        ...
        component = ref ctx.GetComponent<SellPointSignComponent>(entity);
    ...
    static partial void OnEntityCreated(Context ctx, Entity entity, ref SellPointSignComponent component, Dictionary<string, Entity> childEntities);
}
