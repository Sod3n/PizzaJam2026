...
[EntityDefinition(
    typeof(Transform2D),
    typeof(UpgradeSellerComponent),
    typeof(StaticBody2D),
    typeof(CollisionShape2D))]
public static partial class UpgradeSellerDefinition
{
    public static Entity Create(Context ctx, Vector2 position)
    {
        var entity = ctx.CreateEntity<UpgradeSellerComponent>();

        ref var component = ref ctx.GetComponent<UpgradeSellerComponent>(entity);
        ...
        component = ref ctx.GetComponent<UpgradeSellerComponent>(entity);
    ...
    static partial void OnEntityCreated(Context ctx, Entity entity, ref UpgradeSellerComponent component, Dictionary<string, Entity> childEntities);
}
