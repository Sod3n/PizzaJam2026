...
[EntityDefinition(
    typeof(Transform2D),
    typeof(UpgradeGathererComponent),
    typeof(StaticBody2D),
    typeof(CollisionShape2D))]
public static partial class UpgradeGathererDefinition
{
    public static Entity Create(Context ctx, Vector2 position)
    {
        var entity = ctx.CreateEntity<UpgradeGathererComponent>();

        ref var component = ref ctx.GetComponent<UpgradeGathererComponent>(entity);
        ...
        component = ref ctx.GetComponent<UpgradeGathererComponent>(entity);
    ...
    static partial void OnEntityCreated(Context ctx, Entity entity, ref UpgradeGathererComponent component, Dictionary<string, Entity> childEntities);
}
