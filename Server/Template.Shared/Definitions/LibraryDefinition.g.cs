...
public static partial class LibraryDefinition
{
    ...
    {
        var entity = ctx.CreateEntity<LibraryComponent>();

        ref var component = ref ctx.GetComponent<LibraryComponent>(entity);
        ...
        component = ref ctx.GetComponent<LibraryComponent>(entity);
