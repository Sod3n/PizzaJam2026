...
[EntityDefinition(
    typeof(Transform2D),
    typeof(UpgradeAssistantComponent),
    typeof(StaticBody2D),
    typeof(CollisionShape2D))]
public static partial class UpgradeAssistantDefinition
{
    public static Entity Create(Context ctx, Vector2 position)
    {
        var entity = ctx.CreateEntity<UpgradeAssistantComponent>();

        ref var component = ref ctx.GetComponent<UpgradeAssistantComponent>(entity);
        ...
        component = ref ctx.GetComponent<UpgradeAssistantComponent>(entity);
    ...
    static partial void OnEntityCreated(Context ctx, Entity entity, ref UpgradeAssistantComponent component, Dictionary<string, Entity> childEntities);
}
