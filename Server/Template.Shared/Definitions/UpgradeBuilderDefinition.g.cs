...
[EntityDefinition(
    typeof(Transform2D),
    typeof(UpgradeBuilderComponent),
    typeof(StaticBody2D),
    typeof(CollisionShape2D))]
public static partial class UpgradeBuilderDefinition
{
    public static Entity Create(Context ctx, Vector2 position)
    {
        var entity = ctx.CreateEntity<UpgradeBuilderComponent>();

        ref var component = ref ctx.GetComponent<UpgradeBuilderComponent>(entity);
        ...
        component = ref ctx.GetComponent<UpgradeBuilderComponent>(entity);
    ...
    static partial void OnEntityCreated(Context ctx, Entity entity, ref UpgradeBuilderComponent component, Dictionary<string, Entity> childEntities);
}
