...
public static partial class CarrotFarmDefinition
{
    ...
    {
        var entity = ctx.CreateEntity<CarrotFarmComponent>();

        ref var component = ref ctx.GetComponent<CarrotFarmComponent>(entity);
        ...
        ctx.AddComponent(entity, CollisionShape2D.CreateRectangle(new Vector2(4.608341f, 0.70518863f)));

        var childEntities = new Dictionary<string, Entity>
        {
        };
        component = ref ctx.GetComponent<CarrotFarmComponent>(entity);
