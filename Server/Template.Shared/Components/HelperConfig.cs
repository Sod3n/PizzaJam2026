...
public static class HelperConfig
{
    ...
    public static readonly HelperInfo Gatherer  = new("gatherer",  "Lefantis", 15, 30, 8f, 16f);
    public static readonly HelperInfo Seller    = new("seller",    "Mochi", 8, 16, 8f, 16f);
    public static readonly HelperInfo Builder   = new("builder",   "Brix", 30, 60, 8f, 16f);
